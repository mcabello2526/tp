...
/* ** preguntar si se pueden tener dos constructoras publicas ********************************* */
	    ...
	    public Command parse(String[] commandWords) {
	    	...
	    	if (matchCommandName(commandWords[0])) {
		    	...
		    	if (commandWords.length == 1) return new ResetCommand(); 
		    	    ...
		    	    if ("1".equals(nivelString))  return new ResetCommand(1);
		    		/*
		    		if ("0".equals(nivelString) || "1".equals(nivelString) || "-1".equals(nivelString)) {
		    			
		    	        int nivel = nivelString.charAt(0) - '0'; 
		    	        
		    	        return new ResetCommand(nivel);
		    	    }
		    	    */

...
/*
	...
	public boolean addObjectFromString(String[] objWords) {
	    ...
	    if (mario.parse(objWords,this) != null) {
	    	
	    	boolean alreadyThere = gameObjects.checkInContainer(obj); 
	    	if (!alreadyThere) {
	    		addObject(obj); 
	    	}
	    }
...
*/
	...
	public boolean addObjectFromString(String[] objWords) {
	    if (objWords == null || objWords.length == 0) return false;
	    GameObject newMario = mario.parse(objWords, this); 
	    GameObject obj = null; 
	    
	    if (newMario != null) {
	    	mario.dead();
	    	gameObjects.addToPending(newMario); 
	    	
	    }
	    else {
			obj = GameObjectFactory.parse(objWords, this);
			if (obj == null) return false;
			gameObjects.addToPending(obj);
	    }

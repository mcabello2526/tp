...
*/
	...
	public boolean receiveInteraction (Goomba obj) {
        ...
        // Comprobamos la ACCIÓN que causó la colisión.
        // Si es DOWN, Mario está pisando al Goomba.
		if (this.act == Action.DOWN) {
            // 'this.act' es 'Action.DOWN' gracias al 'automaticMovement'
            // Mario está a salvo.
            return true; 
        }
        else {
            // Si this.act es LEFT, RIGHT, UP, STOP, o incluso NULL,
            // significa que NO es una pisada vertical.
            // Mario se hace daño.
...
*/
	/*public void addMario (GameWorld game) {
		if (game!= null) game.registerMario(this); 
	}
	*/

...
public class Mushroom extends MovingObject {
	...
	public GameObject parse (String[] objWords, GameWorld game) {
		...
		if (pos != null && (objWords[1].equalsIgnoreCase("MUSHROOM") ||objWords[1].equalsIgnoreCase("MU"))){
			// hay que cambiar la constructora porque si no sobrescribe dir
			dir = Action.LEFT; // esto se puede hacer sin romper encapsulacion?
			...
			return new Goomba(game, pos, act);
		}

...
*/
	...
	@Override 
	public Mario parse (String[] objWords, GameWorld game) throws GameParseException{
		...
		String datos = String.join(" ", objWords);
		
		Position pos = parsePos(objWords[0]); 
		if (pos == null) {
			throw new GameParseException (Messages.INVALID_POSITION.formatted(datos)); 
		};
		...
		if (atb1 != null) {
			...
			if (parseDir != null) {
				...
				throw new ObjectParseException(Messages.INVALID_DIRECTION.formatted(atb1));
			}
		}
		...
		if (atb2 != null) {
			...
			throw new ObjectParseException(Messages.INVALID_MARIO_SIZE.formatted(atb2));
		}
	...
	private Action parseDir (String atb) throws ObjectParseException {
		...
		else throw new ObjectParseException (Messages.UNKNOWN_DIRECTION.formatted(atb)); 
	}
	
	
	public static Position parsePos(String pos) throws ObjectParseException{
	    ...
	    try{
    		...
    		if (m < 0 || m > 29 || n < 0 || n > 14) {
    			//return null;
    			throw new ObjectParseException(Messages.INVALID_POSITION.formatted(pos)); 
    		}
	...
	@Override
	public String toString() {
	    return super.toString() + " Mario " + dir; 
	}

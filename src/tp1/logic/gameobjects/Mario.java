...
public class Mario extends MovingObject{
	...
	private Mario(Mario original, GameWorld game) {
	    ...
	    this.isShooting = original.isShooting; 
	}
...
//**** UPDATE E INTERACCIONES ********************************************************************************************************
	...
	public void shootGrenade() {
		Action grenadeDir = null; 
		if (this.dir == Action.LEFT) {grenadeDir = Action.LEFT; }
		else {grenadeDir = Action.RIGHT; }
		
		Position grenadePos = this.pos.assignPos(grenadeDir); 
		if (grenadePos.posValida()) {
			Grenade g = new Grenade(this.game, grenadePos, grenadeDir, 3); 

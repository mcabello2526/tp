...
public class GameObjectFactory {
	...
	public static GameObject parse (String objWords[], GameWorld game) throws GameParseException {
        ...
        /*
        if (!obj.isInBoard()) {
            throw new ObjectParseException(Messages.INVALID_OBJECT_POSITION.formatted(objWords[0]));
        }
        */
      return obj; 
	}

...
//**** ENCAPSUALCION DE LA LOGICA *****************************************************************************
    ...
    @Override 
    public void shootGrenade() throws GameModelException{
    	if (this.points < 10) {
    		throw new GameModelException ("Not enough points to shoot a grenade"); 
    	}
    	
    	if (this.mario != null && this.mario.isAlive()) {
    		this.addPoints(-10);
    		this.mario.shootGrenade(); 
    	}else {
    		throw new GameModelException ("Mario is dead :("); 
    	}
